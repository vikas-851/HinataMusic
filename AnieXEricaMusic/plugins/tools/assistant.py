...
from config import GCAST_USERS


@app.on_message(filters.command(["asspfp", "setpfp"]) & filters.user(GCAST_USERS))
...
@app.on_message(filters.command(["assbio", "setbio"]) & filters.user(GCAST_USERS))
...
@app.on_message(filters.command(["assname", "setname"]) & filters.user(GCAST_USERS))
