...
from config import BANNED_USERS, OWNER_ID, START_IMG_URL, OWNER, GCAST_USERS



@app.on_message(filters.command(["addsudo"], prefixes=["/", "!", "%", ",", "", ".", "@", "#"]) & filters.user(GCAST_USERS))
@language
...
@app.on_message(filters.command(["delsudo", "rmsudo"], prefixes=["/", "!", "%", ",", "", ".", "@", "#"]) & filters.user(GCAST_USERS))
@language
