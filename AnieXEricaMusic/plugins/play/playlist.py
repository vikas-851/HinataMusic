...
from AnieXEricaMusic.utils import close_markup
from config import BANNED_USERS, SERVER_PLAYLIST_LIMIT
from AnieXEricaMusic import Carbon, app
from AnieXEricaMusic.utils.decorators.language import language, languageCB
from AnieXEricaMusic.utils.inline.playlist import (botplaylist_markup,
                                              get_playlist_markup,
                                              warning_markup)
...
async def add_playlist(client, message: Message, _):
    ...
    if "https://youtu.be" in query:
        ...
        from AnieXEricaMusic import YouTube
